// =========================================================================
// GOOGLE EARTH ENGINE (GEE) - 4-POINT POLYGON WITH 7-METER BUFFER & SCALE
// =========================================================================
...
// This enables the native on-screen scale ruler in the bottom right corner.
Map.setControlVisibility({scaleControl: true});


// 4. DEFINE BASE FACILITY POLYGON VIA YOUR EXACT 4 VERTICES
...
// Apply a total 7-meter outer buffer (2m previous + 5m added)
var facilityPolygon = basePolygon.buffer(7); 
...
Map.addLayer(facilityPolygon, {color: 'red', fillColor: '00000000'}, 'Buffered Site Boundary (7m)');
Map.addLayer(basePolygon, {color: 'gray', fillColor: '00000000'}, 'Original Base Footprint', false);


// 5. INTERNAL SURFACE VARIATION ANALYSIS (Sentinel-2 BSI)
...
// 6. TARGETED INTERNAL THERMAL SIGNATURE (Landsat 9 Thermal)
...
// 7. PRECISE STATISTICAL EXTRACTION FOR AUDITING
...
print('7m Buffered Area Extent (Sq Meters):', facilityPolygon.area());
