// =========================================================================
// GOOGLE EARTH ENGINE (GEE) - 4-POINT POLYGON WITH 2-METER BUFFER
// =========================================================================
...
// Apply a strict 2-meter outer buffer (1m previous + 1m added)
var facilityPolygon = basePolygon.buffer(2); 
...
Map.addLayer(facilityPolygon, {color: 'red', fillColor: '00000000'}, 'Buffered Site Boundary (2m)');
...
print('2m Buffered Area Extent (Sq Meters):', facilityPolygon.area());
