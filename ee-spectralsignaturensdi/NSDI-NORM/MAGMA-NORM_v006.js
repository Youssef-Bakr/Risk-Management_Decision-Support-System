// =========================================================================
// GOOGLE EARTH ENGINE (GEE) - 4-POINT EXACT INFRASTRUCTURE POLYGON
// =========================================================================


// 1. DEFINE FACILITY BOUNDARY VIA YOUR EXACT 4 VERTICES
// Coordinates are organized in a counter-clockwise loop to correctly form the polygon.
...
// Center the map display on the exact footprint bounds (Zoom level 18)
Map.centerObject(facilityPolygon, 18);

// Add the perfect-fit layer to the interactive map interface
Map.addLayer(facilityPolygon, {color: 'red', fillColor: '00000000'}, 'Exact 4-Point Site Boundary');


// 2. INTERNAL SURFACE VARIATION ANALYSIS (Sentinel-2 BSI)
// Bare Soil Index calculations restricted purely inside your custom polygon
...
// 3. TARGETED INTERNAL THERMAL SIGNATURE (Landsat 9 Thermal)
// Isolated surface temperatures to monitor internal heat outputs from processing units
...
// Calculates environmental metrics derived exclusively from inside your defined parameters
...
print('--- ENVIRONMENTAL METRICS FROM SPECIFIED BOUNDS ---');
print('Defined Facility Area (Sq Meters):', facilityPolygon.area());
