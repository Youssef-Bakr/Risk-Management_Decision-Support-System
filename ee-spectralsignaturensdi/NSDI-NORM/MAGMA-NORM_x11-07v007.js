...
// --- 3. DYNAMIC TIME-SERIES LAYER INJECTION (WITH SAR RGB SYMBOLOGY) ---
var optVis = {bands: ['B4', 'B3', 'B2'], min: 0, max: 3000};
// UPGRADED: SAR False-Color RGB Symbology [VV, VH, VV]
...
// Updated SAR to mandate both VV and VH availability for RGB
...
// Execute Tactical Layer Automation
...
addDynamicDatedLayers(s1_Jul26, 'SAR RGB (S1) July 2026', sarVis, true);

// --- 4. ANALYTICAL BASELINE LAYERS (CORRESPONDING DIRECTLY TO DASHBOARD CHARTS) ---
...
// --- 5. SAFE MONTHLY TEMPORAL AGGREGATION PATTERN ---
...
print('======================================================================================');
print('- SAR RGB INTEGRATION: Sentinel-1 collections now require both VV and VH polarizations to generate a dynamic RGB false-color visualization [VV, VH, VV]. This drastically improves the identification of geotechnical textures and landfill cellular boundaries.');
print('- CHART-TO-LAYER MAPPING: Six new static baseline maps (Charts 1-6) have been added to the Earth Engine Layer Manager. These visually correspond to the exact datasets displayed in the right-side analytical dashboard.');
print('======================================================================================');
