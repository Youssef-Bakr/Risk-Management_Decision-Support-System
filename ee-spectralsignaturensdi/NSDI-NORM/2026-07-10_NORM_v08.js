...
// Updated to explicitly include July 10, 2026 (Exclusive end date is set to July 11 to capture the 10th)
...
// Map Aggregation Pipelines for Charts
...
// --- 5. VISUAL RECONNAISSANCE & INUNDATION LAYER OVERLAYS ---
...
// =========================================================================================
// REAL-TIME TACTICAL ISR SNAPSHOTS: Grabbing the absolute latest available image up to today
// =========================================================================================
// Sorts the entire collection in descending time order and extracts the newest valid image
var latestOptical = s2TacticalOptical.sort('system:time_start', false).first().clip(facilityImpactZone);
Map.addLayer(latestOptical, {bands: ['B4', 'B3', 'B2'], min: 0, max: 2500}, '4. Optical ISR (Latest: Jul 10 2026)', false);

var latestSAR = s1TacticalRadar.sort('system:time_start', false).first().clip(facilityImpactZone);
Map.addLayer(latestSAR, {bands: ['VV', 'VH', 'VV'], min: -22, max: -3}, '5. SAR ISR (Latest: Jul 10 2026)', true);
// =========================================================================================
...
dashboardPanel.add(ui.Label('Safety Analysis Report | NORM MAGMA UAE | 2020-2026', {fontWeight: 'bold', fontSize: '18px', color: '#2d3436'}));
...
generateSafetyCriticalChart(seriesPrecipMax, 'HV_Hydrological_Rate_mm_hr', 
  'CHART 1. HYDROLOGICAL HAZARD: Flash Inundation Peak [2020 - Jul 10 2026]', 
...
generateSafetyCriticalChart(seriesWindDir, 'Wind_Direction_Deg', 
  'CHART 2. EXPOSURE PATHWAY: Atmospheric Vector Dispersion Angle [2020 - Jul 10 2026]', 
...
generateSafetyCriticalChart(seriesWindV, 'V_Vector', 
  'CHART 3. ATMOSPHERIC DYNAMICS: Cross-Boundary Velocity (V-Vector) [2020 - Jul 10 2026]', 
...
generateSafetyCriticalChart(seriesLST, 'HV_Thermal_LST_C', 
  'CHART 4. THERMAL LOADING: Structural Surface Heat Degradation [2020 - Jul 10 2026]', 
...
generateSafetyCriticalChart(seriesFireT21, 'HV_Incinerator_Temp_K', 
  'CHART 5. EXOTHERMIC RISK: NASA FIRMS Core Brightness Anomaly [2020 - Jul 10 2026]', 
...
generateSafetyCriticalChart(seriesFireConf, 'HV_Fire_Confidence_Pct', 
  'CHART 6. ALGORITHM VALIDATION: Signal-to-Noise Confidence Index [2020 - Jul 10 2026]', 
...
generateSafetyCriticalChart(seriesSAR_VV, 'VV', 
  'CHART 7. GEOTECHNICAL MONITORING: VV Radar Backscatter Variance [2020 - Jul 10 2026]', 
...
generateSafetyCriticalChart(seriesSAR_VH, 'VH', 
  'CHART 8. VOLUMETRIC DEFECT CAPTURE: VH Radar Backscatter Variance [2020 - Jul 10 2026]', 
...
print('                EVALUATION PERIOD: 2020-01-01 TO 2026-07-10 (LATEST)                  ');
print('======================================================================================');
print(' ');
print('--------------------------------------------------------------------------------------');
...
print('--------------------------------------------------------------------------------------');
print(' ');
print('1. CLIMATE RISK ASSESSMENT & SEA LEVEL RISE (SLR) VULNERABILITY MODEL [2020 - 10 Jul 2026]');
print('--------------------------------------------------------------------------------------');
...
print(' ');
print('2. HYDROLOGICAL FLOOD RISK PROFILE: INUNDATION VELOCITY ANALYSIS [2020 - 10 Jul 2026]');
print('--------------------------------------------------------------------------------------');
...
print(' ');
print('3. ATMOSPHERIC PLUME DISPERSION DYNAMICS [2020 - 10 Jul 2026]');
print('--------------------------------------------------------------------------------------');
...
print(' ');
print('4. THERMAL RUNAWAY & FIRE EARLY WARNING ARCHITECTURE [2020 - 10 Jul 2026]');
print('--------------------------------------------------------------------------------------');
...
print(' ');
print('5. SPACE-BASED TACTICAL ISR DEFENSE INTEGRATION [2020 - 10 Jul 2026]');
print('--------------------------------------------------------------------------------------');
