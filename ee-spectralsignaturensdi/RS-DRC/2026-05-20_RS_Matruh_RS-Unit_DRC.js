...
//----------------------------------------------------------------------------------------
/*
2026-05-20_RS_Matruh_RS-Unit_DRC
*/
//----------------------------------------------------------------------------------------
...
//  Filter for Egypt
var egypt_FAO = gaulLevel1.filter(ee.Filter.eq('ADM0_NAME', 'Egypt'));
print (egypt_FAO)
//  Filter for New Valley Governorate
var Matruh = egypt_FAO.filter(ee.Filter.eq('ADM1_NAME', 'Matruh'));

// Visualize on map
Map.centerObject(T, 14);
...
// ----------------------------------------------------------------------------------------
var Label02 = ui.Label('-------------------------------------------------\nThe ECOSTRESS Tiled Ancillary NDVI\n(70m spatial resolution)', {whiteSpace: 'pre'});
panel.widgets().set(2, Label02);
// ----------------------------------------------------------------------------------------
var Label03 = ui.Label('min: -1.0\nmax: 1.0\nColor-code_palette:\n[00008B, A9A9A9, CD853F, FFFF00, 90EE90, 006400]', {whiteSpace: 'pre'});
