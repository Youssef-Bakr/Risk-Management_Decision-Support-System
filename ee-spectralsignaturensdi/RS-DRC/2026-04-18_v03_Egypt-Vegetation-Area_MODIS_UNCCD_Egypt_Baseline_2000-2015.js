...
//Vegetation_Area/Egypt/2026-04-11_v06_Egypt-Vegetation-Area_MODIS_UNCCD_Egypt_Baseline_2000-2015
...
// ----------------------------------------------------------------------------------------
Map.addLayer(ndvi.median().clip(Egypt), ndviVis, 'Baseline 2000 >>> 2015');
// ----------------------------------------------------------------------------------------
...
var Label05 = ui.Label(
                        {value: ' Date: UNCCD Baseline 2000 >>> 2015)' ,style: {fontSize: '20px', fontWeight: 'bold'},}
                      );  
...
// ----------------------------------------------------------------------------------------
var Label09 = ui.Label('https://github.com/Youssef-Bakr', {whiteSpace: 'pre'});
