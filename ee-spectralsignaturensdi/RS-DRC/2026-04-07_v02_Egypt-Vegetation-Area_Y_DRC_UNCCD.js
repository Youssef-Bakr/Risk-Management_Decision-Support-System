//----------------------------------------------------------------------------------------
//Egypt_Vegetation_Area/2026-04-07_v02_Egypt-Vegetation-Area_Y_DRC_UNCCD
//Youssef Mohamed Bakr _ +201121121000 _ (www.linkedin.com/in/youssef-bakr)
//----------------------------------------------------------------------------------------
//Filter.date('2017-01-01', '2017-01-30')
//----------------------------------------------------------------------------------------
...
var dataset = ee.ImageCollection('MODIS/061/MOD13Q1')
                  .filter(ee.Filter.date('2017-01-01', '2017-01-30'))
// ----------------------------------------------------------------------------------------                  
...
var Label05 = ui.Label(
                        {value: ' Date: (2017-01-01 >>> 2017-01-30)' ,style: {fontSize: '20px', fontWeight: 'bold'},}
                      );  
...
// ----------------------------------------------------------------------------------------
var Label09 = ui.Label('(DRC)(MoA) _ (Egypt_Vegetation_Area/2026-04-07_v02_Egypt-Vegetation-Area_Y_DRC_UNCCD)', {whiteSpace: 'pre'});
