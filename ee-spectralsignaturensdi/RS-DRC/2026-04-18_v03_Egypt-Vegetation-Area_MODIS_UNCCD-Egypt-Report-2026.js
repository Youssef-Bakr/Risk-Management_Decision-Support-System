...
//2017
// ----------------------------------------------------------------------------------------
var dataset_2017 = ee.ImageCollection('MODIS/061/MOD13Q1')
                  .filter(ee.Filter.date('2017-01-01', '2017-12-31'))
// ----------------------------------------------------------------------------------------                  
var ndvi_2017 = dataset_2017.select('NDVI');
// ----------------------------------------------------------------------------------------
var ndviVis = {
  min: 0.0,
  max: 8000.0,
...
// ----------------------------------------------------------------------------------------
Map.addLayer(ndvi_2017.median().clip(Egypt), ndviVis, 'NDVI 2017');
// ----------------------------------------------------------------------------------------
//2025
// ----------------------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------------------
Map.addLayer(ndvi.median().clip(Egypt), ndviVis, 'NDVI 2025');
// ----------------------------------------------------------------------------------------
// ----------------------------------------------------------------------------------------

//NDVI-2025 _ Subtract _ NDVI-2017
var NDVI_sub_2025_2017 = ndvi.median().clip(Egypt).subtract(ndvi_2017.median().clip(Egypt));
Map.addLayer(NDVI_sub_2025_2017, {min: -8000.0, max: 8000.0, palette: ['red', 'white', 'green']}, 'NDVI-2025 _ Subtract _ NDVI-2017');
...
var Label05 = ui.Label(
                        {value: ' Date: (2025-01-01 >>> 2025-12-31)' ,style: {fontSize: '20px', fontWeight: 'bold'},}
                      );  
...
// ----------------------------------------------------------------------------------------
var Label09 = ui.Label('Egypt NDVI-2025 _ Subtract _ Egypt_NDVI-2017\nhttps://github.com/Youssef-Bakr/DRC_UNCCD_GEE\nhttps://github.com/Youssef-Bakr', {whiteSpace: 'pre'});
