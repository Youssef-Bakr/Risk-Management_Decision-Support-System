...
// --- 5. VISUAL RECONNAISSANCE & INUNDATION LAYER OVERLAYS WITH EXPLICIT DATES ---
...
// Increased width to 650px to guarantee chart axis labels do not get cut off
var dashboardPanel = ui.Panel({style: {width: '650px', padding: '20px', backgroundColor: '#ffffff', border: '1px solid #d63031'}});
dashboardPanel.add(ui.Label('QUANTITATIVE RISK & ISR CONTROL DASHBOARD // Analysis Dates: 2020-01-01 TO 2026-07-01', {fontWeight: 'bold', fontSize: '18px', color: '#2d3436'}));
dashboardPanel.add(ui.Label('Youssef Bakr (www.linkedin.com/in/youssef-bakr)(+201121121000)', {fontSize: '12px', fontWeight: 'bold', color: '#c0392b', margin: '0 0 20px 0'}));
