...
//17
/* ========================================================================================
 * ADVANCED NORM SITE CLIMATE & RADIOLOGICAL DISPERSION DASHBOARD (V5 - HIGH RESOLUTION)
 * ========================================================================================
 * Target Coordinates: [52.769692825414495, 24.081562392352257] (Al Ruwais NORM Landfill)
 * Study Timeframe:    2020-01-01 to 2025-12-31
 * * CORE UPGRADES:
 * 1. Unified Precipitation Metric: ALL rainfall data now utilizes NASA GPM IMERG (mm/hr).
 * 2. Axis Detailing: X and Y axes across all charts feature verbose, descriptive labeling.
...
// GPM IMERG Flash Flood (Natively mm/hr) - Replaced CHIRPS entirely
...
var monthlyPrecipMeanRate = safeMonthlyAggregate(imerg, 'Rain_Rate_mm_hr', 'mean'); // Replaces sum accumulation
...
// Advanced Chart Builder with Detailed X/Y Axes
...
addDetailedChart(monthlyPrecipMaxRate, 'Rain_Rate_mm_hr', 
  ...
  'Timeline (Monthly Max Values: 2020 - 2025)', 
  'Peak Intensity Rate (mm / hour)', 
  '#e74c3c', 'bar', 0, 
...
addDetailedChart(monthlyPrecipMeanRate, 'Rain_Rate_mm_hr', 
  ...
  'Timeline (Monthly Averages: 2020 - 2025)', 
  'Average Baseline Rate (mm / hour)', 
  '#2980b9', 'bar', 0, 
...
addDetailedChart(monthlyWindV, 'V_Vector', 
  ...
  'Vector Velocity (m / s)', 
  '#16a085', 'line', null, 
  "X-Axis represents the monthly progression. Y-Axis measures lateral velocity. POSITIVE (+): Wind blows NORTH toward the Gulf (Marine risk). NEGATIVE (-): Wind blows SOUTH driving plumes inland (Terrestrial/Desert risk).");
...
addDetailedChart(monthlyLST, 'LST_Celsius', 
  ...
  'Skin Temperature (°C)', 
  '#d35400', 'line', null, 
  "X-Axis represents the monthly progression. Y-Axis captures the physical contact heat of the ground (not ambient air). RISK: Desert ground temps exceeding 45°C relentlessly degrade HDPE geomembrane landfill liners via thermal embrittlement.");
