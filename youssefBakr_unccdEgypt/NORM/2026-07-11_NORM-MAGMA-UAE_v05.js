...
// NEW: Sentinel-5P Aerosol Index (Dust & Sand Storms)
...
// NEW: NASA/USDA SMAP Soil Moisture (Drought & Dust Storm Predisposition)
...
Map.addLayer(s5pAER.mean().clip(facilityImpactZone), {min: -1, max: 2.0, palette: ['black', 'blue', 'purple', 'cyan', 'green', 'yellow', 'red']}, '5. Dust/Aerosol Plume (S5P) | Acq: Jan 2020-Jul 2026', true);
Map.addLayer(s5pNO2.mean().clip(facilityImpactZone), {min: 0, max: 0.0001, palette: ['black', 'blue', 'purple', 'cyan', 'green', 'yellow', 'red']}, '6. Mean NO2 Plume (S5P) | Acq: Jan 2020-Jul 2026', false);
Map.addLayer(s5pCH4.mean().clip(facilityImpactZone), {min: 1750, max: 1900, palette: ['black', 'blue', 'purple', 'cyan', 'green', 'yellow', 'red']}, '7. Mean CH4 [Methane] Plume (S5P) | Acq: Jan 2020-Jul 2026', false);
...
generateSafetyCriticalChart(seriesAER, 'Aerosol_Index', 
  ...
  "Monitors suspended dust and particulate matter. Positive values indicate UV-absorbing aerosols (desert dust, ash). High peaks correlate with Shamal-driven sandstorms that can clog HVAC systems and expose workers.",
  "COPERNICUS/S5P/NRTI/L3_AER_AI. Method: Max monthly aggregation.");
...
generateSafetyCriticalChart(seriesSM, 'Surface_Soil_Moisture_mm', 
  ...
  "Tracks terrain aridity. Prolonged periods of low soil moisture exacerbate dust storm severity by loosening topsoil around the facility perimeter.",
  "NASA_USDA/HSL/SMAP10KM_soil_moisture. Method: Monthly mean aggregation.");
...
generateSafetyCriticalChart(seriesNO2, 'NO2_Density_mol_m2', 
  'CHART 5. ATMOSPHERIC CHEMISTRY: NO2 Emissions', 'NO2 Density [mol/m^2]', '#d63031', 'line', 
...
generateSafetyCriticalChart(seriesCH4, 'CH4_Mixing_Ratio_ppb', 
  'CHART 6. GREENHOUSE GASES: Methane (CH4) Emissions', 'CH4 Mixing Ratio [ppb]', '#f39c12', 'line', 
...
// --- 6. AUTOMATED CONSOLE LOGGING WITH REFERENCES & ANALYSIS ---
print('======================================================================================');
print('                OFFICIAL QUANTITATIVE RISK ASSESSMENT & SAFETY DOSSIER                ');
print('                FACILITY: CENTRALIZED NORM TREATMENT PLANT (AL RUWAIS)                ');
print('======================================================================================');
print(' ');
print('DUST & SAND STORM (SHAMAL) ANALYSIS:');
print('--------------------------------------------------------------------------------------');
print('- DUST LOADING HAZARD: The Sentinel-5P UV Aerosol Index indicates severe, episodic spikes in airborne particulate matter. These are primarily driven by localized sandstorms originating from the surrounding hyper-arid environment.');
print('- OPERATIONAL IMPACT: High aerosol indices pose severe risks to the NORM incineration filtration systems (baghouses/HEPA filters), accelerating degradation and increasing maintenance cycles. Dust storms also obscure visual ISR (Optical) monitoring.');
print('- SOIL MOISTURE CORRELATION: The NASA SMAP data consistently shows surface soil moisture hovering near critical lows. This absolute aridity prevents natural topsoil crusting, making the surrounding 20km Zone of Exposure highly susceptible to wind-shear erosion.');
print(' ');
