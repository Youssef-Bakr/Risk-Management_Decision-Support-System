...
// FIXED: HLS standard RGB bands are B04, B03, B02 (not B4, B3, B2). Name updated to start with date logic.
var hlsLayer = ui.Map.Layer(hlsRecent.clip(facilityImpactZone), {bands: ['B04', 'B03', 'B02'], min: 0, max: 3000}, 'Fetching Date... | HLS Optical', true);
...
hlsRecent.date().format('YYYY-MM-dd').evaluate(function(dateStr) {
  if (dateStr) {
    ...
    hlsLayer.setName(dateStr + ' | HLS Optical');
  } else {
    hlsLayer.setName('Unavailable | HLS Optical');
  }
});
...
print('======================================================================================');
print('- HLS RENDER FIX: NASA HLS band nomenclature corrected to B04, B03, B02 to ensure proper RGB optical mapping.');
print('- LAYER RENAMING: All dynamically loaded satellite layers (HLS, Sentinel-1, Sentinel-2) have been reformatted so the acquisition date appears first in the Layer Manager list for rapid visual sorting.');
print('======================================================================================');
